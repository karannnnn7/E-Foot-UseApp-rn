                ...
                <View className="mx-5">
                    ...
                    <View>
                        <View className="mt-5 flex-row items-center justify-between">
                            <TouchableOpacity onPress={() => setSelected('Pending (10)')} className={`p-3 rounded-lg ${selected === 'Pending (10)' ? 'bg-[#171ad4]' : 'bg-[#261D37]'}`}>
                                <Text className="font-ChakraPetchBold text-sm text-[#D1DCD8]">Pending (10)</Text>
                            </TouchableOpacity>

                            <TouchableOpacity onPress={() => setSelected('Accepted (10)')} className={`p-3 rounded-lg ${selected === 'Accepted (10)' ? 'bg-[#171ad4]' : 'bg-[#261D37]'}`}>
                                <Text className="font-ChakraPetchBold text-sm text-[#D1DCD8]">Accepted (10)</Text>
                            </TouchableOpacity>

                            <TouchableOpacity onPress={() => setSelected('Dispute (7)')} className={`p-3 rounded-lg ${selected === 'Dispute (7)' ? 'bg-[#171ad4]' : 'bg-[#261D37]'}`}>
                        ...
                        <View className="mt-5 flex-row items-center space-x-7">
                            <TouchableOpacity onPress={() => setSelected('Win (9)')} className={`p-3 rounded-lg ${selected === 'Win (9)' ? 'bg-[#171ad4]' : 'bg-[#261D37]'}`}>
                                <Text className="font-ChakraPetchBold text-sm text-[#D1DCD8]">Win (9)</Text>
                            </TouchableOpacity>

                            <TouchableOpacity onPress={() => setSelected('lose (9)')} className={`p-3 rounded-lg ${selected === 'lose (9)' ? 'bg-[#171ad4]' : 'bg-[#261D37]'}`}>
                                <Text className="font-ChakraPetchBold text-sm text-[#D1DCD8]">lose (9)</Text>
                            </TouchableOpacity>

                            <TouchableOpacity onPress={() => setSelected('Draw (10)')} className={`p-3 rounded-lg ${selected === 'Draw (10)' ? 'bg-[#171ad4]' : 'bg-[#261D37]'}`}>
